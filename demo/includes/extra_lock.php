...
<div class="page-lock">
	<div class="page-logo">
		...
		<h1 style="font-size:50px; color:white">NHÀ HÀNG</h1>
		</a>
	</div>
	<div class="page-body">
		<div class="lock-head">
		...
		<div class="lock-body">
			...
			<form class="lock-form pull-left" action="index.html" method="post">
				...
				<div class="form-group">
					<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Nhập mật khẩu..." name="password"/>
				</div>
		...
		<div class="lock-bottom">
			<a href="">Đăng nhập bằng tài khoản khác</a>
		</div>
	</div>
	<!--
