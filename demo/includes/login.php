...
<div class="content">
	...
	<form class="login-form" action="index.php" method="post">
		...
		<div class="alert alert-danger display-hide">
			...
			<span>
			Xin vui lòng nhập đầy đủ thông tin. </span>
		</div>
		<div class="form-group">
			<!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
			<label class="control-label visible-ie8 visible-ie9">Tài Khoản...</label>
			<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Tài Khoản..." name="username"/>
		</div>
		<div class="form-group">
		...
		<div class="create-account">
			<p>
				<a href="javascript:;" id="register-btn" class="uppercase">Tạo Tài Khoản Mới</a>
			</p>
		</div>
	</form>
	<!-- END LOGIN FORM -->
	...
	<form class="forget-form" action="index.html" method="post">
		<h3>Quên Mật Khẩu ?</h3>
		<p>
			Vui lòng nhập email để reset mật khẩu
		</p>
		<div class="form-group">
		...
		<div class="form-actions">
			...
			<button type="submit" class="btn btn-success uppercase pull-right">OK</button>
		</div>
	</form>
	...
	<form class="register-form" action="index.php" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control placeholder-no-fix" type="text" placeholder="Thành phố" name="city"/>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Quốc gia</label>
		...
		<div class="form-actions">
			<button type="button" id="register-back-btn" class="btn btn-default">Trở về</button>
